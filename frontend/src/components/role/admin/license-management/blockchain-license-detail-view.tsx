        ...
        <DescriptionView
          ...
          items={[
            { icon: <Code />, title: 'Mã giấy phép', value: queryBlockchainLicenseVerify.data?.data.licenseCode },
            {
              ...
              value: (
                <Link
                  to={`/admin/business-management/${queryBlockchainLicenseVerify.data?.data.businessId}`}
            ...
            },
            {
              ...
              value: (
                <Link
                  to={`/admin/dossier-management/${queryBlockchainLicenseVerify.data?.data.dossierId}`}
                  className='font-semibold text-blue-500 hover:underline'
                >
